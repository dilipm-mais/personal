looker.plugins.visualizations.add({
  ...
  create: function(element, config){
    ...
    element.innerHTML = `
      <style>
        .flow-root{display:flex;align-items:center;justify-content:space-between;width:100%;height:140px;box-sizing:border-box;padding:0px}
        ...
        .arrow-label-top{font-size:16px;font-weight:700;margin-bottom:0px}
        .arrow-label-bottom{font-size:14px;margin-top0:px;color:#555}
